...
```{r, echo = FALSE}
knitr::include_graphics("figs/cases.png")
```

```{r, echo = FALSE}
knitr::include_graphics("figs/deaths.png")
```

```{r, echo = FALSE}
knitr::include_graphics("figs/heat_map.png")
```

```{r, echo = FALSE}
knitr::include_graphics("figs/accum_weeks.png")
```

```{r, echo = FALSE}
knitr::include_graphics("figs/accum_weeks_comp.png")
```
